...
def register():
  ...
  return render_template_string(base_style + '<div class="container" style="max-width:400px"><div class="card"><h2>REGISTER</h2><form method="POST"><input name="username" placeholder="USER"><input type="password" name="password" placeholder="PASS"><button>Create Account</button></form></div></div>')
